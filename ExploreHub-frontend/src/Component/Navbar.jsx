...
<nav class="bg-gray-800 fixed w-full z-20 top-0 start-0 border-b border-gray-200">
  <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
  <a href="/" class="flex items-center space-x-3 rtl:space-x-reverse">
      {/* <img src="#" class="h-8" alt="" /> */}
      <span class="self-center text-2xl font-semibold whitespace-nowrap text-white">ExploreHub</span>
  </a>
  <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
      <a href="/admin">
        <button type="button" class="text-white bg-cyan-700 hover:bg-cyan-900 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center">Admin</button>
      </a>
  ...
  <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
    <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0">
      ...
      <li>
        <a href="/parks" class="block py-2 px-3 text-white rounded hover:bg-orange-500 md:hover:bg-transparent md:hover:text-orange-500 md:p-0">Where To go</a>
      </li>
      <li>
