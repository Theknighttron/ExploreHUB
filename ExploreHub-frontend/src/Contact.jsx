    ...
    <div>
        ...
        <section class="bg-white mt-10">
            <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                ...
                <form action="https://formsubmit.co/chrisspaul2050@gmail.com" method='post' class="space-y-8">
                    <div>
                    ...
                    <button type="submit" class="py-3 px-5 text-sm font-medium text-center text-white rounded-lg bg-cyan-500 sm:w-fit hover:bg-cyan-700 focus:ring-4 focus:outline-none focus:ring-primary-300">Send message</button>
                </form>
            </div>
        </section>
