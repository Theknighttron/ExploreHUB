...
const Card = () => {
  return (
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 sm:grid-cols-2 gap-10">
        ...
        <button type="button" class="text-white flex justify-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center">
            See more
